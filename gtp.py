...
# Translate from vertex (tuple, ranges from (1,1) to (19,19)) to a gtp
# coordinate (A1 to T19, skipping I column)
...
class Engine(object):
    ...
    def __init__(self, game_obj, name="gtp (python library)", version="0.2"):
        ...
        self.known_commands = [
            field[4:] for field in dir(self) if field.startswith("cmd_")] + ["kgs-chat"]
