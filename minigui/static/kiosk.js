define(["require", "exports", "./app", "./board", "./heat_map", "./layer", "./log", "./util", "./winrate_graph"], function (require, exports, app_1, board_1, heat_map_1, lyr, log_1, util_1, winrate_graph_1) {
    ...
    class KioskApp extends app_1.App {
        constructor() {
            ...
            this.connect().then(() => {
                let mainBoard = new board_1.Board('main-board', this.size, [lyr.Label, lyr.BoardStones, [lyr.Variation, 'pv'], lyr.Annotations]);
                let searchBoard = new board_1.Board('search-board', this.size, [[lyr.Caption, 'search'], lyr.BoardStones, [lyr.Variation, 'search']]);
                let nBoard = new board_1.Board('n-board', this.size, [[lyr.Caption, 'N'], [lyr.HeatMap, 'n', heat_map_1.heatMapN], lyr.BoardStones]);
                let dqBoard = new board_1.Board('dq-board', this.size, [[lyr.Caption, 'ΔQ'], [lyr.HeatMap, 'dq', heat_map_1.heatMapDq], lyr.BoardStones]);
