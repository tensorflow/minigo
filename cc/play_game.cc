...
// This is a simple binary that replays moves from a game.
// It was used to profile the Position implementation via Valgrind.
int main() {
  // Moves from Jiang Weijie vs Yang Dingxin, 3rd Quzhou-Lanke Cup tournament
  // semifinal: http://eidogo.com/#titles/3qcsf2
